            ...
            @auth
                ...
                <script>
                    (function(){
                        ...
                        if(!btn || !menu) return;
                        let open = false;
                        function closeMenu(){ menu.classList.add('hidden'); btn.setAttribute('aria-expanded','false'); open=false; }
                        function openMenu(){ menu.classList.remove('hidden'); btn.setAttribute('aria-expanded','true'); open=true; }
