<section>
    ...
    <form id="password-update-form" method="post" action="{{ route('password.update') }}" class="mt-4 space-y-4 max-w-xl">
        @csrf
        @method('put')
        ...
        <div class="flex items-center gap-4">
            <button type="button" class="btn btn-primary" data-confirm-form="password-update-form">Guardar</button>
            ...
            <p
                ...
                class="text-sm text-neutral-dark/70">Guardado.</p>
            @endif
        </div>
    </form>
</section>