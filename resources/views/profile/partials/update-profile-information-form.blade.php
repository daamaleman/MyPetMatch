<section>
    ...
    <form id="profile-update-form" method="post" action="{{ route('profile.update') }}" class="mt-4 space-y-4 max-w-xl">
        @csrf
        @method('patch')
        ...
        <div class="flex items-center gap-4">
            <button type="button" class="btn btn-primary" data-confirm-form="profile-update-form">Guardar</button>
